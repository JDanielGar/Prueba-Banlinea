...
// DOM interfase
    ...
    $(".submit-button").click(function(){
        if(validateData()){
            var car_brand = $("#car_branding_select option:selected" ).text();
            var car_model = $("#model_car_select option:selected" ).text();
            var car_year = $("#year_car_select option:selected" ).text();
